...
@IBDesignable
    ...
    @IBInspectable var outerColor: UIColor = UIColor.blackColor() { didSet { setNeedsDisplay() } }
    //sets the color of the inner object/circle
    @IBInspectable var innerColor: UIColor = UIColor.redColor() { didSet { setNeedsDisplay() } }
